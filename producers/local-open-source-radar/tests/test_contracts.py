...
MAIN_AGENTS_PROMPT_PATH = REPO_ROOT / "skills/agents-report/prompts/agents-report-v2.md"
...
class SourceContractTests(unittest.TestCase):
    ...
    def test_main_agents_prompt_keeps_main_report_title(self):
        prompt = MAIN_AGENTS_PROMPT_PATH.read_text(encoding="utf-8")

        self.assertIn("**✨新热门开源**", prompt)
