...
4. Run the collector against a small real query, e.g. `category=paper&window=24h&limit=3`.
5. Verify `schemaVersion=1`, `page.count`, `page.hasMore`, `items[*].links.aihot`, and Beijing-time conversion before declaring the migration complete.
